def read_old_bank_accounts(file_path):
    ...
    with open(file_path, 'r') as file:
        for line_num, line in enumerate(file, 1):
            ...
            if clean_line.startswith("00000"):
                continue
            ...
            try:
                ...
                account_number = clean_line[0:5]  # FIXED
                name = clean_line[6:26]           # FIXED
                ...
                accounts.append({
                    'account_number': account_number, # Removed lstrip('0') so '01234' doesn't become '1234'
                    'name': name.strip(),
                    'status': status,
                    'balance': balance,
